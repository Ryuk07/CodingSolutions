Task: You have an array a1,a2,…,an. All ai

are positive integers.

In one step you can choose three distinct indices i
, j, and k (i≠j; i≠k; j≠k) and assign the sum of aj and ak to ai, i. e. make ai=aj+ak
...
and d (3≤n≤100; 1≤d≤100) — the number of elements in the array a and the value d
...
, j=1, k=2 and make a5=a1+a2=2+1=3. Array a will become [2,1,5,3,3]

.

After that we can make a3=a5+a2=3+1=4
. Array will become [2,1,4,3,3] and all elements are less or equal than d=4.
