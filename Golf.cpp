Task: It's a lockdown. You’re bored in your house and are playing golf in the hallway.
...
In each test case, the tiles covered by the ball for N=5
and k=2 are {0,2,4,6} in the forward journey and {6,4,2,0}
